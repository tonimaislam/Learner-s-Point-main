...
{
    public partial class forgot_student_passwoard : Form
    {
        static public string randomcode, to, admin_email;
        public forgot_student_passwoard()
        {
            InitializeComponent();
        }
        ...
        private void search_button_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataReader mdr;
            string selectQuery = "SELECT Email FROM student WHERE Email = '" + email_search_box.Text + "'";
            ...
            if (mdr.Read())
            {
                ...
                this.Close();
                student_email_verification obj = new student_email_verification();
                obj.ShowDialog();
